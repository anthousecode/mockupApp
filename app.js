...
var apiStaticScenesIdRouter 	   = require('./routes/staticSceneId')
var apiExportVideoRouter   = require('./routes/exportVideo/exportvideo')
var apiScenesPngTransform  = require('./routes/pngtransform')
var apiStaticScenesPngTransform  = require('./routes/staticPngTransform')
var apiShadowPngTransform  = require('./routes/pngShadowTransform')
...
app.use('/scenes', apiShadowPngTransform )
app.use('/static', apiStaticScenesPngTransform)

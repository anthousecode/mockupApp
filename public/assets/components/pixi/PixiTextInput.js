 ...
 */
function PixiTextInput(eposition, text, style, password, useNativeTextInput) {
...
console.log('Достигли бока')

this.caret.position.y += this.caretHeight;
...
PixiTextInput.prototype.drawElements = function() {
	...
	this.caret.drawRect(1, 1, 1, this.caretHeight - 2);
	this.caret.endFill();
}
